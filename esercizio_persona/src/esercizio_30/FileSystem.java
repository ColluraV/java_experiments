...
public interface FileSystem {
	...
	/* Restituisce il File corrente impostato a livello di costruttore
	...
	*/
	...
	Se il file corrente non è definito restituisce un Optional null
	...
	*/
	...
	/* Restituisce il size in bytes se il file corrente non è una directory */

	public long fileSize();

	/* Restituisce il size in bytes se il file corrente non è una directory

	Nel caso di directory restituisce la somma del size di tutti i files

	della directory corrente e di tutte le directory, a qualsiasi livello
	...
	*/
	...
	Crea la directory con il nome specificato sotto il File corrente, se
