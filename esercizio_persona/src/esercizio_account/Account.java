...
public interface Account<T> {
		...
		/* Restituisce tutti gli oggetti utente sortati (nome, cognome) */ T[] users(EnumSortType sortType);
		/* Restituisce il primo utente (sono ordinati per nome, cognome) */ T firstUser();
		/* Restituisce l'uktimo utente (sono ordinati per nome, cognome) */ T lastUser();
